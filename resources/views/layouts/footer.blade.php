<div class="footer-wrapper">
    <div class="footer">
        <div class="footer_item">
            {{--        <p class="footer_item-heading">О проекте</p>--}}
        ...
        <div class="footer_item">
            {{--        <p class="footer_item-heading">Инструкции</p>--}}
        ...
        <!--    <div class="footer_item">
                ...
                <ul class="footer_item-list">
                    <li><a href="">Для блогеров</a></li>
                    <li><a href="">Для конструкторов</a></li>
                    <li><a href="">Для брендов</a></li>
                </ul>
            </div>-->
        ...
        <div class="footer_item">
            ...
            <p class="footer_item-subheading d-none d-sm-block">Подпишитесь на рассылку, чтобы узнавать
                о
                новых поступлениях, акциях и скидках.</p>
